...
Early-stage LLM security projects with fewer than **10 GitHub stars**.

These stay visible for discovery while they gain traction. On periodic review they may move to the [main list](README.md) (≥10★), to [Unavailable Projects](deprecated.md) if gone, or be removed if inactive.
